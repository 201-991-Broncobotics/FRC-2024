...
public class PIGECalculator {
    private final double kP, kI, kE, kG, minPower, maxPower, zeroPosition;
    ...
    public PIGECalculator(double kP, double kI, double kG, double kE, double minPower, double maxPower, double startingPosition, double zeroPosition) {
        this.kP = kP;
        this.kI = kI;
        this.kG = kG;
        this.kE = kE;
    ...
    public double update(double currentPosition) {
        ...
        double position_correction, integral_correction, gravity_correction;
        ...
        return Math.max(-maxPower, Math.min(maxPower, position_correction + integral_correction + gravity_correction));
    }
